...
name: nix-flakes-env
description: |
  使用 Nix Flakes 创建和管理项目开发环境。涵盖 flake.nix 模板、多语言 devShell、Snowfall Lib 集成、输入管理、direnv 配置等。
  ...
  outputs = inputs:
    inputs.flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        lib = inputs.snowfall-lib.lib // inputs.snowfall-lib.lib.${system};
      in {
        devShells.default = pkgs.mkShell {
          packages = with pkgs; [
            lib.nixpkgs-fmt
